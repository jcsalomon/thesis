...
\ifxetex	% XɘLᴬTeX & fonts
	...
	% Work-around for buggy \XeTeXmathaccent
	\AtBeginDocument{\let\olddot\dot}
	\AtBeginDocument{\renewcommand\dot[1]{\olddot{#1}{}}}
	% Stuff missing from unicode-math.tex
	\makeatletter
